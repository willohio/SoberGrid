...
- (void)loadLocations {
  ...
  //  CLCircularRegion *newRegion = [[CLCircularRegion alloc] initCircularRegionWithCenter:coord
                                                               //   radius:10.0
                                                              //identifier:[NSString stringWithFormat:@"%f, %f", coord.latitude, coord.longitude]];
    CLCircularRegion *newRegion = [[CLCircularRegion alloc] initWithCenter:coord radius:10.0 identifier:[NSString stringWithFormat:@"%f, %f", coord.latitude, coord.longitude]];
    
    // Create an annotation to show where the region is located on the map.
    XHAnnotation *myRegionAnnotation = [[XHAnnotation alloc] initWithCLRegion:newRegion title:@"Location message" subtitle:self.message.geolocations];
