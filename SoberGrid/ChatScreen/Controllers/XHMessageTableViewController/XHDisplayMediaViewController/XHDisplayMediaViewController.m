...
- (void)setMessage:(id<XHMessageModel>)message {
    ...
    if ([message messageMediaType] == XHBubbleMessageMediaTypeVideo) {
        ...
        if (message.thumbnailUrl) {
            ...
            [self.photoImageView sd_setImageWithURL:[NSURL URLWithString:[message originPhotoUrl]] placeholderImage:[UIImage imageNamed:@"placeholderImage"] options:SDWebImageRetryFailed completed:^(UIImage *image, NSError *error, SDImageCacheType cacheType, NSURL *imageURL) {
