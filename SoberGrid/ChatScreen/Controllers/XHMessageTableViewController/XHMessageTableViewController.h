...
@property (nonatomic, strong) SavedPhraseController* topViewController;
@property (nonatomic, strong) PhotosViewController * photoesController;
/**
 *  数据源，显示多少消息
 */
 ...
 *  是否支持发送表情
 */
@property (nonatomic, assign) BOOL allowsSendFace; // default is N0

@property (nonatomic, assign) BOOL allowsSendButton; // default is YES
/**
 *  输入框的样式，默认为扁平化
 */
