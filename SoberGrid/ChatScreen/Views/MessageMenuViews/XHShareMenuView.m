...
// 每行有4个
#define kXHShareMenuPerRowItemCount (kIsiPad ? 10 : 5)
...
- (void)setup {
    ...
    if (!_shareMenuScrollView) {
        UIScrollView *shareMenuScrollView = [[UIScrollView alloc] initWithFrame:CGRectMake((isIPad)?50:0, 0, 320, CGRectGetHeight(self.bounds) - kXHShareMenuPageControlHeight)];
        ...
        // Agile change
        shareMenuScrollView.center = CGPointMake(self.center.x, shareMenuScrollView.center.y);
