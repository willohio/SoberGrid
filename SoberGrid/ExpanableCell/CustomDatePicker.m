...
-(void) defaultDataInit
{
    ...
    self.dayImage = [UIImage imageWithColor:[UIColor colorWithRed:48.0/255.0 green:48.0/255.0 blue:48.0/255.0 alpha:1] andSize:CGSizeMake(50, 50)];
    self.monthImage = [UIImage imageWithColor:[UIColor colorWithRed:48.0/255.0 green:48.0/255.0 blue:48.0/255.0 alpha:1] andSize:CGSizeMake(120, 50)];
    self.yearImage = [UIImage imageWithColor:[UIColor colorWithRed:48.0/255.0 green:48.0/255.0 blue:48.0/255.0 alpha:1] andSize:CGSizeMake(80, 50)];
