...
#define kTotalViewHeight   250// 400
...
{
    DAReloadActivityButton *viewButton = [[DAReloadActivityButton alloc] initWithFrame:CGRectMake(160,246,50,50)];
    if(isIPad){
        viewButton.center = CGPointMake(370,176);
    }
    else if (isIPhone5){
        viewButton.center = CGPointMake(152,176);
    }
    else if (isIPhone4) {
        viewButton.center = CGPointMake(152,176);
    }
...
//        _tintColor = [UIColor colorWithRed:224.0 / 255.0 green:37.0 / 244.0 blue:172.0 / 255.0 alpha:1.0];
