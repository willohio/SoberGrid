...
- (void)drawRect:(CGRect)rect
{
    ...
    CGContextRef mainMaskContextRef = CGBitmapContextCreate(NULL,
                                                        ...
                                                        maskColorSpaceRef, 
                                                        0);
   // CGContextRef shineMaskContextRef = CGBitmapContextCreate(NULL,rect.size.width,rect.size.height,8,rect.size.width,maskColorSpaceRef,0);
  ...
  //  CGContextFillRect(shineMaskContextRef, CGRectMake(0,0, rect.size.width / 8 * 5,rect.size.height));
