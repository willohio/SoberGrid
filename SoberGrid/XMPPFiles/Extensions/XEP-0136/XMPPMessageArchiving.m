...
-(void)xmppStreamDeleteConversation:(XMPPStream *)sender
{
    XMPPLogTrace();
...
NSXMLElement *pref = [NSXMLElement elementWithName:@"remove" xmlns:XMLNS_XMPP_ARCHIVE ];
XMPPIQ *iq = [XMPPIQ iqWithType:@"set" to:nil elementID:nil child:pref];
